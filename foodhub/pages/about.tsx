    ...
    <div className="bg-[url('/food.jpeg')]  bg-cover bg-center bg-no-repeat h-full  lg:h-screen overflow-x-hidden  w-full">
      ...
      <div>
        <div className="flex justify-center items-center py-3 px-2">
          <a
            href="#_"
            className="relative inline-flex border-[1.8px] border-white items-center justify-center h-60 w-72 px-6 py-3 overflow-hidden font-bold text-white rounded-lg hover:shadow-white shadow-2xl group"
          >
            ...
            <span className="relative">press to go to our website</span>
          </a>
        </div>
      </div>
    </div>
