    ...
    <div className="h-screen w-full bg-[url('/loginBg.jpg')] bg-cover bg-center bg-no-repeat flex justify-center items-center p-4 sm:p-0 bg-opacity-100">
      <div className="flex flex-col bg-zinc-500 rounded-lg items-center justify-center h-2/3 shadow-[#312f2f] shadow-xl w-full sm:w-auto p-6 ">
        ...
        <input
          ...
          className="border-gray-600 placeholder:text-gray-600 pl-3 border-2 m-1 h-12 sm:h-10 rounded-lg hover:border-gray-50 w-72 sm:w-96 max-w-md "
        ></input>
        ...
        <input
          ...
          type="email"
          placeholder="Email"
          className="border-gray-600 placeholder:text-gray-600 pl-3 border-2 m-1 h-11 sm:h-10 rounded-lg hover:border-gray-50 w-72 sm:w-96 max-w-md "
        ></input>
        <input
        ...
        <div className="flex flex-col items-center">
          <button className="flex justify-center h-11 sm:h-10 items-center my-3 h-10 w-72 sm:w-96 max-w-md font-bold text-base bg-white border border-white rounded-lg shadow-md px-4 py-2 hover:border-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
          ...
          <button className="flex items-center h-11 sm:h-10 justify-center my-3 h-10 w-72 sm:w-96 max-w-md font-bold text-base bg-white border border-white rounded-lg shadow-md px-4 py-2 hover:border-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
